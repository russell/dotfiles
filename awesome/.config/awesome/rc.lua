...
local menu_emacs = { "emacs", "emacs" }


if has_fdo then
   mymainmenu = freedesktop.menu.build({
         before = { menu_awesome },
         after =  { menu_terminal, menu_emacs }
   })
end
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "u",
       function ()
          awful.spawn.raise_or_spawn("x-www-browser")
       end,
       {description = "run or raise Browser", group = "applications"}
    ),
...
beautiful.font = "Iosevka Fixed SS11 13"
beautiful.hotkeys_font = "Iosevka Fixed SS11 13"
beautiful.hotkeys_description_font = "Iosevka Fixed SS11 13"
...
beautiful.hotkeys_bg = xrdb.background
beautiful.hotkeys_border_width = 3
