...
(custom-theme-set-faces
 ...
 '(erc-notice-face ((t (:foreground "#888a85" :weight normal))))
 '(fg:erc-color-face14 ((t (:foreground "#729fcf"))))
 '(fg:erc-color-face2 ((t (:foreground "#8ae234"))))
 '(fg:erc-color-face12 ((t (:foreground "#e6a8df"))))
 '(fg:erc-color-face1 ((t (:foreground "#c17d11"))))
 '(jabber-roster-user-away ((t (:foreground "tomato" :slant italic :weight normal))))
 '(jabber-roster-user-dnd ((t (:foreground "firebrick" :slant italic :weight normal))))
 '(jabber-roster-user-online ((t (:foreground "#729fcf" :slant normal :weight bold))))
 '(jabber-roster-user-xa ((t (:foreground "#c17d11" :slant italic))))
 '(jabber-chat-prompt-local ((t (:foreground "#729fcf" :weight bold))))
 '(jabber-activity-personal-face ((t (:foreground "#729fcf" :weight bold))))
 '(jabber-rare-time-face ((t (:underline t :foreground "#8ae234"))))
