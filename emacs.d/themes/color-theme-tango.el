...
(defun color-theme-tango ()
  ...
  (color-theme-install
   `(color-theme-tango
     ...
     (mumamo-background-chunk-major ((t (:background ,alum6))))
     (mumamo-background-chunk-submode1 ((t (:background ,alum5))))
     (mumamo-background-chunk-submode2 ((t (:background ,alum5))))
     (mumamo-background-chunk-submode3 ((t (:background ,alum5))))
     (mumamo-background-chunk-submode4 ((t (:background ,alum5))))
